package com.example.dailydiamond.util
...
class TinyDB(appContext: Context) {
    ...
    private fun setupFullPath(imageName: String): String {
        ...
        if (isExternalStorageReadable && isExternalStorageWritable && !mFolder.exists()) {
            if (!mFolder.mkdirs()) {
                Log.e("TAG", "Failed to setup folder")
                return ""
            }
        }
...
//    fun getWallpaperResponse(trending: Boolean): List<WallpaperResponseItem>? {
//        val moshi = Moshi.Builder().build()
//        val jsonAdapter: JsonAdapter<List<WallpaperResponseItem>> = moshi.adapter(
//            Types.newParameterizedType(
//                List::class.java,
//                WallpaperResponseItem::class.java
//            )
//        )
//
//        val json = getString("WallPaper_$trending", "")
...
//    }
//
//    fun setWallpaperResponse(trending: Boolean, body: List<WallpaperResponseItem>) {
//        val moshi = Moshi.Builder().build()
//        val jsonAdapter: JsonAdapter<List<WallpaperResponseItem>> = moshi.adapter(
//            Types.newParameterizedType(
//                List::class.java,
...
//        )
//
//        putString("WallPaper_$trending", jsonAdapter.toJson(body))
//    }
